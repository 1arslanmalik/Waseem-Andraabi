const id = "iui.md";
						...
						const data = {slug:"iui-treatment",title:"IUI Treatment",description:"Discover the IUI treatment process, a fertility procedure where sperm is placed directly into the uterus to improve the chances of conception."};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/arsla/OneDrive/Desktop/waseem-andrabi/src/content/services/iui.md",
							rawData: undefined,
						};
