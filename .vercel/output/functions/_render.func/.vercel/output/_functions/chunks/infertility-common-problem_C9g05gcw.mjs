const id = "infertility-common-problem.md";
						const collection = "blog";
						const slug = "infertility-common-problem";
						...
						const data = {title:"Why Has Infertility Become a Common Problem Today?",description:"Explore the rising causes of infertility, including lifestyle and environmental factors.",pubDate:new Date(1725906600000),heroImage:"/blog_images/female-infertility.jpg",author:"Dr. Vivek Kakkad"};
						const _internal = {
							type: 'content',
							filePath: "C:/Users/arsla/OneDrive/Desktop/waseem-andrabi/src/content/blog/infertility-common-problem.md",
							rawData: undefined,
						};
